...
function load_site(site) {
    ...
    fetch(`/sites/${site}`, {
        ...
        .then(data => {
            ...
            //}
            // build each email
            element.innerHTML = `<h5 style="width:20%;">${title}</h5><p style="display:inline-block;"><img src="static/{image}" style="width:400px; height:400px;"><p style="display:inline-block; width:50%;">${description}</p><span><img src="https://www.publicdomainpictures.net/pictures/40000/velka/red-heart-1362916005N5Z.jpg" style="width:20px; height:20px;"></span>`;
